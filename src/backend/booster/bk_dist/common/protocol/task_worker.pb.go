...
func (PBCompressType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_task_worker_f661a10bc97cbca2, []int{0}
}
...
func (PBCacheStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_task_worker_f661a10bc97cbca2, []int{1}
}
...
const (
	...
	PBCmdType_ENSUREWORKERREQ PBCmdType = 8
	PBCmdType_ENSUREWORKERRSP PBCmdType = 9
...
func (PBCmdType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_task_worker_f661a10bc97cbca2, []int{2}
}
...
func (*PBStatEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_worker_f661a10bc97cbca2, []int{3}
}
...
func (*PBResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_worker_f661a10bc97cbca2, []int{4}
}
...
func (*PBCacheParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_worker_f661a10bc97cbca2, []int{5}
}
...
func (*PBCacheResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_worker_f661a10bc97cbca2, []int{6}
}
...
func (*PBHead) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_worker_f661a10bc97cbca2, []int{7}
}
...
func (*PBBodyDispatchTaskReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_worker_f661a10bc97cbca2, []int{8}
}
...
func (*PBBodyDispatchTaskRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_worker_f661a10bc97cbca2, []int{9}
}
...
func (*PBBodySyncTimeRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_worker_f661a10bc97cbca2, []int{10}
}
...
type PBBodyEnsureWorkerRsp struct {
	Ifok                 *bool    `protobuf:"varint,1,req,name=ifok" json:"ifok,omitempty"`
	RspCode              *string  `protobuf:"bytes,2,req,name=rspCode" json:"rspCode,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *PBBodyEnsureWorkerRsp) Reset()         { *m = PBBodyEnsureWorkerRsp{} }
func (m *PBBodyEnsureWorkerRsp) String() string { return proto.CompactTextString(m) }
func (*PBBodyEnsureWorkerRsp) ProtoMessage()    {}
func (*PBBodyEnsureWorkerRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_worker_f661a10bc97cbca2, []int{11}
}
func (m *PBBodyEnsureWorkerRsp) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_PBBodyEnsureWorkerRsp.Unmarshal(m, b)
}
func (m *PBBodyEnsureWorkerRsp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_PBBodyEnsureWorkerRsp.Marshal(b, m, deterministic)
}
func (dst *PBBodyEnsureWorkerRsp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PBBodyEnsureWorkerRsp.Merge(dst, src)
}
func (m *PBBodyEnsureWorkerRsp) XXX_Size() int {
	return xxx_messageInfo_PBBodyEnsureWorkerRsp.Size(m)
}
func (m *PBBodyEnsureWorkerRsp) XXX_DiscardUnknown() {
	xxx_messageInfo_PBBodyEnsureWorkerRsp.DiscardUnknown(m)
}

var xxx_messageInfo_PBBodyEnsureWorkerRsp proto.InternalMessageInfo

func (m *PBBodyEnsureWorkerRsp) GetIfok() bool {
	if m != nil && m.Ifok != nil {
		return *m.Ifok
	}
	return false
...
func (m *PBBodyEnsureWorkerRsp) GetRspCode() string {
...
func (*PBBodySendFileReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_worker_f661a10bc97cbca2, []int{12}
}
...
func (*PBBodySendFileRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_worker_f661a10bc97cbca2, []int{13}
}
...
func (*PBBodyCheckCacheReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_worker_f661a10bc97cbca2, []int{14}
}
...
func (*PBBodyCheckCacheRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_worker_f661a10bc97cbca2, []int{15}
}
...
func init() {
	...
	proto.RegisterType((*PBBodyEnsureWorkerRsp)(nil), "protocol.PBBodyEnsureWorkerRsp")
...
func init() { proto.RegisterFile("task_worker.proto", fileDescriptor_task_worker_f661a10bc97cbca2) }

var fileDescriptor_task_worker_f661a10bc97cbca2 = []byte{
	...
	,
}
